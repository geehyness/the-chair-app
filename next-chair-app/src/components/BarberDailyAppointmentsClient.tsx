...
export default function BarberDailyAppointmentsClient({ barbers, todayAppointments }: BarberDailyAppointmentsClientProps) {
  ...
  // Group appointments by barber for easier display
            ...
            {barbers.map(barber => (
              ...
              >
                ...
                <VStack align="stretch" spacing={3}>
                  {(appointmentsByBarber[barber._id] && appointmentsByBarber[barber._id].length > 0) ? (
                    appointmentsByBarber[barber._id].map(appt => (
